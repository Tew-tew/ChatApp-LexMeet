...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            <nav className="border-b border-gray-100" style={{ background: 'linear-gradient(90deg, #5e1b89, #f4512c)' }}>
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink href={route('chat-page')} active={route().current('chat-page')}>
                                    Chat
                                </NavLink>
                            </div>
                        </div>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('chat-page')} active={route().current('chat-page')}>
                            Chat page
                        </ResponsiveNavLink>
                    </div>
